...
from app.api.v1 import health, broker, trade, trade_upload, holding, dashboard, portfolio, realized_gain, tax, tax_export, corporate_action, csv_import, zerodha, upstox, groww, fno_pnl, reconstruction, crypto, harvesting, replay, monte_carlo, ais, admin_itr, billing, journal, journal_analytics, backtest, tax_harvest_intelligence, admin, me, trade_analysis
...
app.include_router(trade_upload.router, prefix="/api/v1")
...
app.include_router(journal_analytics.router, prefix="/api/v1")
app.include_router(backtest.router, prefix="/api/v1")
app.include_router(tax_harvest_intelligence.router, prefix="/api/v1")
app.include_router(admin.router, prefix="/api/v1")
app.include_router(me.router, prefix="/api/v1")
app.include_router(trade_analysis.router, prefix="/api/v1")